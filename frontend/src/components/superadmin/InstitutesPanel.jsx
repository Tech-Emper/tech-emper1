...
import { Building, Plus, Users, Upload, Edit, X, Search, AlertCircle, UserPlus, Trash2 } from 'lucide-react';
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
                <div>
                    <h1 className="text-3xl font-black flex items-center gap-3" style={{ color: 'var(--text-auth-primary)' }}>
                        <Building className="w-8 h-8 text-[#14BA80]" />
                        Institutes
                    </h1>
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-6 py-3 bg-[#14BA80] hover:bg-[#0E8F63] text-white rounded-xl font-bold shadow-lg shadow-[#14BA80]/20 transition-all"
                >
            ...
            <div className="rounded-3xl p-6 md:p-8 border backdrop-blur-xl" style={{ backgroundColor: 'var(--bg-auth-card)', borderColor: 'var(--border-auth-card)' }}>
                <div className="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
                    <h2 className="text-xl font-bold flex items-center gap-2" style={{ color: 'var(--text-auth-primary)' }}>
                        ...
                        <span className="bg-[#14BA80]/20 text-[#14BA80] py-1 px-3 rounded-full text-sm">
                    ...
                    <div className="relative w-full sm:w-auto">
                        ...
                        <input
                            ...
                            className="w-full sm:w-64 pl-10 pr-4 py-2.5 rounded-xl border focus:ring-2 focus:ring-[#14BA80] focus:border-[#14BA80] outline-none transition-all"
                                        ...
                                        >
                                            ...
                                            <td className="py-4 px-4">
                                                <div className="flex items-center justify-end gap-3">
                                                    ...
                                                    <label
                                                        className="flex items-center gap-2 p-2 bg-[#14BA80]/20 text-[#14BA80] rounded-lg hover:bg-[#14BA80]/30 transition-colors cursor-pointer"
                            ...
                            <form onSubmit={handleFormSubmit}>
                                <div className="mb-6">
                                    ...
                                    <input
                                        ...
                                        autoFocus
                                        className={`w-full px-4 py-3 rounded-xl border focus:ring-2 outline-none transition-all ${formError ? 'border-red-500 focus:ring-red-500' : 'focus:ring-[#14BA80]'}`}
                                ...
                                <div className="mb-6">
                                    <div className="flex justify-between items-center mb-4">
                                        ...
                                        <button
                                            ...
                                            className="flex items-center gap-1 px-3 py-1.5 bg-[#15A9E8]/20 text-[#15A9E8] rounded-lg text-sm font-bold hover:bg-[#15A9E8]/30 transition-colors"
                                        >
                                                    ...
                                                    {orgKeyMembers.map((member, index) => (
                                                        <div key={`new-${index}`} className="p-4 rounded-xl border" style={{ borderColor: 'var(--border-auth-card)', backgroundColor: 'var(--bg-auth-input)' }}>
                                                            ...
                                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                                                <input type="text" placeholder="First Name *" value={member.first_name} onChange={(e) => updateKeyMember(index, 'first_name', e.target.value)} className="w-full px-3 py-2 rounded-lg border focus:ring-2 focus:ring-[#14BA80] outline-none text-sm" style={{ backgroundColor: 'var(--bg-auth-main)', borderColor: 'var(--border-auth-card)', color: 'var(--text-auth-primary)' }} required />
                                                                <input type="text" placeholder="Last Name" value={member.last_name} onChange={(e) => updateKeyMember(index, 'last_name', e.target.value)} className="w-full px-3 py-2 rounded-lg border focus:ring-2 focus:ring-[#14BA80] outline-none text-sm" style={{ backgroundColor: 'var(--bg-auth-main)', borderColor: 'var(--border-auth-card)', color: 'var(--text-auth-primary)' }} />
                                                                <input type="email" placeholder="Email ID *" value={member.email} onChange={(e) => updateKeyMember(index, 'email', e.target.value)} className="w-full px-3 py-2 rounded-lg border focus:ring-2 focus:ring-[#14BA80] outline-none text-sm" style={{ backgroundColor: 'var(--bg-auth-main)', borderColor: 'var(--border-auth-card)', color: 'var(--text-auth-primary)' }} required />
                                                                <input type="text" placeholder="Phone Number *" value={member.mobile} onChange={(e) => updateKeyMember(index, 'mobile', e.target.value)} className="w-full px-3 py-2 rounded-lg border focus:ring-2 focus:ring-[#14BA80] outline-none text-sm" style={{ backgroundColor: 'var(--bg-auth-main)', borderColor: 'var(--border-auth-card)', color: 'var(--text-auth-primary)' }} required />
                                                                <input type="text" placeholder="Designation" value={member.designation} onChange={(e) => updateKeyMember(index, 'designation', e.target.value)} className="w-full px-3 py-2 rounded-lg border focus:ring-2 focus:ring-[#14BA80] outline-none text-sm" style={{ backgroundColor: 'var(--bg-auth-main)', borderColor: 'var(--border-auth-card)', color: 'var(--text-auth-primary)' }} />
                                                                <select value={member.role} onChange={(e) => updateKeyMember(index, 'role', e.target.value)} className="w-full px-3 py-2 rounded-lg border focus:ring-2 focus:ring-[#14BA80] outline-none text-sm" style={{ backgroundColor: 'var(--bg-auth-main)', borderColor: 'var(--border-auth-card)', color: 'var(--text-auth-primary)' }}>
                                ...
                                <button
                                    type="submit"
                                    className="w-full py-3.5 bg-[#14BA80] hover:bg-[#0E8F63] text-white font-bold rounded-xl shadow-lg shadow-[#14BA80]/20 transition-all flex justify-center items-center gap-2"
                                >
